...
### Multimodal `Modelfile`

An example of a `Modelfile` for a multimodal model using llama3.2 with image processing capabilities:
...
# sets a custom system message to specify the behavior of the chat assistant
SYSTEM You are a multimodal assistant capable of processing text and images.

# specify the path to the vision model
