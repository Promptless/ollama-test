...
The current build includes support for multimodal models, such as `mllama`, which require additional image processing capabilities. Ensure that your environment is set up to handle these models by installing the necessary dependencies and configuring your build scripts accordingly.
### Windows
