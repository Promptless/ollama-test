...
To enable image processing for the Llama3.2-vision model in the `/generate` API, ensure that the necessary build instructions are followed to support this feature. This includes setting up the environment to handle image processing routines and multimodal model support.
### MacOS
