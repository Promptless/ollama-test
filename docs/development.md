...
For Windows builds, ensure that MSYS2 and Clang tools are installed. Use the following commands to set up the environment:

```bash
# Download and install MSYS2
# Install necessary Clang tools
# Ensure environment paths include MSYS2 and Clang binaries
```
### MacOS
...
- Clang and Make.  There are multiple options on how to go about installing these tools on Windows.  We have verified the following, but others may work as well:  
  - [MSYS2](https://www.msys2.org/)
