...
For Windows builds, make sure to use Clang compatible with the deepseek patch.
### MacOS
...
- Clang, GCC, and Make.  There are multiple options on how to go about installing these tools on Windows.  We have verified the following, but others may work as well:  
  - [MSYS2](https://www.msys2.org/)
    - After installing, from an MSYS2 terminal, run `pacman -S mingw-w64-ucrt-x86_64-clang mingw-w64-ucrt-x86_64-gcc make` to install the required tools
